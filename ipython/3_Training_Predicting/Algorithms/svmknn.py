...
class VMContextKNN:
    ...
    def __init__(self, k = 500, sample_size=1000, sampling='recent', similarity='jaccard', weighting='div', last_n_days=None,
                 steps=10, remind=False, pop_boost=0, extend=False, normalize=True, session_key='SessionId',
